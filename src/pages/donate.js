                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="lorem text-center">
                                <h1>Let's Talk</h1>
                                <p>Your compassion today will prevent child abuse and help preserve families for generations to come. FirstMy is dedicated to preventing child abuse by strengthening, equipping, and restoring children and families in crisis… “One Life at a Time."</p>
                                <button type="button" className="btn btn-lg btn-light"><a href="./join" style={{ textDecoration: 'none', color: 'white' }}>Be a Member</a></button>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <h1>Contact Us:</h1>
